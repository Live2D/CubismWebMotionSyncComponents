...
Cubism Web MotionSync Components is included in Live2D Cubism Components.

Cubism Web MotionSync Components は Live2D Cubism Components に含まれます。

Cubism Web MotionSync Components 包括在 Live2D Cubism Components 中。
