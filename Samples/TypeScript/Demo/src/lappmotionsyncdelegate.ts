 ...
 * Cubism SDKの管理を行う。
 */
export class LAppMotionSyncDelegate {
  /**
  ...
  public release(): void {
    ...
    // リソースを解放
    LAppMotionSyncLive2DManager.releaseInstance();
   ...
   * View情報を取得する。
   */
  public getView(): LAppMotionSyncView {
    return this._view;
  }
  ...
  _cubismMotionSyncOption: MotionSyncOption; // Cubism SDK MotionSync Option
  _view: LAppMotionSyncView; // View情報
